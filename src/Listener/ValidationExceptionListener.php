...
class ValidationExceptionListener
{
    ...
    public function __invoke(ExceptionEvent $event): void
    {
        ...
        $event->setResponse(
            new JsonResponse($data, Response::HTTP_BAD_REQUEST, [], true)
        );
    }

    private function formatViolations(ConstraintViolationListInterface $constraintViolationList): ErrorValidationDetails
    {
