...
class ValidationExceptionListenerTest extends AbstractTestCase
{
    ...
    public function testInvoke(): void
    {
        ...
        $constrainViolation = new ConstraintViolation(
            'error',
            null,
            [],
            null,
        ...
        $constrainViolationList = new ConstraintViolationList([$constrainViolation]);

        $event = $this->createExceptionEvent(
            new ValidationException($constrainViolationList)
        );
