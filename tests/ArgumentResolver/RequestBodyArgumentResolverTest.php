...
class RequestBodyArgumentResolverTest extends AbstractTestCase
{
    ...
    public function testSupport(): void
    {
        ...
        $this->assertTrue(
            $this->createResolver()->supports(new Request(), $metadata)
        );
    }
    ...
    public function testResolveThrowsWhenDeserialized(): void
    {
    ...
    public function testResolveThrowsWhenValidationsFails(): void
    {
        ...
        $this->createResolver()->resolve($request, $metadata)->next();
    }
    ...
    public function testResolve(): void
    {
        ...
        $actual = $this->createResolver()->resolve($request, $metadata);
